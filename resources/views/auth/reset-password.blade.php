...
<head>
    ...
    <title>{{ config('cms.name') }} | Reset password</title>
    ...
    <style>
        ...
        .hmg-login-title { margin-bottom: 22px; color: #253244; font-size: 18px; font-weight: 600; text-align: center; }
    ...
    <div class="login-box">
        <div class="card hmg-login-card">
            ...
            <div class="card-body login-card-body hmg-login-body">
                <p class="hmg-login-title">Reset password</p>
