...
use App\TenantModules\Tenants\TrungTamXucTienHaNoi\Support\Models\User;
...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ttxt-website::user.index', compact('users', 'dataGrid'));
    }
    ...
    public function edit($id = null)
    {
        ...
        return view('ttxt-website::user.create', compact('user', 'option_groups'));
    }
    ...
    public function save(Request $request, $id = null)
    {
        ...
        $rules = [
            ...
            'email' => ['required', 'email', Rule::unique('tenant.users', 'email')->ignore($user->id)],
        ];
