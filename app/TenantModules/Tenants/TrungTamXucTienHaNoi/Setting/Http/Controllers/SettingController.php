...
namespace App\TenantModules\Tenants\TrungTamXucTienHaNoi\Setting\Http\Controllers;

use App\TenantModules\Tenants\TrungTamXucTienHaNoi\Support\Models\Page;
...
class SettingController extends Controller
{
    ...
    public function general()
    {
        ...
        return view('ttxt-website::setting.general', compact('settings'));
    }
    ...
    public function social()
    {
        ...
        $settings = Setting::getAllSetting();
        return view('ttxt-website::setting.social', compact('settings'));
    }
    ...
    public function seo()
    {
        ...
        $settings = Setting::getAllSetting();
        return view('ttxt-website::setting.seo', compact('settings'));
    }
    ...
    public function author()
    {
        ...
        $settings = Setting::getAllSetting();
        return view('ttxt-website::setting.author', compact('settings'));
    }
