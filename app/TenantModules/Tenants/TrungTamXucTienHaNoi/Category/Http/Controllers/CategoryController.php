...
namespace App\TenantModules\Tenants\TrungTamXucTienHaNoi\Category\Http\Controllers;
...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ttxt-content::category.index',
            compact(
                'categories',
    ...
    public function edit(Request $request, Category $category)
    {
        ...
        return view('ttxt-content::category.create', compact('category', 'list_category', 'type'));
    }
