...
class User extends Authenticatable
{
    ...
    use HasFactory, Notifiable, LogsActivity, SyncsTenantUserToPlatform;
    ...
    public function hasPermission(string $perm_key): bool
    {
        ...
        $keysToCheck = [];
        $slashKey = str_replace('.', '/', $perm_key);
        $dotKey = str_replace('/', '.', $perm_key);
        ...
        foreach ($keysToCheck as $key) {
            if (in_array($key, $permission_data, true)) {
                return true;
            }
        }
